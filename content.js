...
window.onload = function() { // wait for web page to load
    console.log('Window fully loaded');  // web page is full loaded and parsed
    if (document.location.href.includes('/00Q/o')) { // lead home page
        console.log('On lead page');
    }
    else if (document.location.href.includes('/00Q')) { // lead profile page
        ...
        button.addEventListener('click', function() { // button is clicked
            console.log('button clicked');
            chrome.runtime.sendMessage({ // send message to create window
                type: 'openWindow',
